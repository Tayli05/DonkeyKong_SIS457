...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_MeshBarril_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_MeshBarril;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABarril_Statics::NewProp_MeshBarril_MetaData[] = {
		{ "Category", "Barril" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Barril.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABarril_Statics::NewProp_MeshBarril = { "MeshBarril", nullptr, (EPropertyFlags)0x00200800000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABarril, MeshBarril), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABarril_Statics::NewProp_MeshBarril_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABarril_Statics::NewProp_MeshBarril_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABarril_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABarril_Statics::NewProp_MeshBarril,
	};
	...
	IMPLEMENT_CLASS(ABarril, 2124449767);
